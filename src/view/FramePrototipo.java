 ...
 * @author CAF
 */
public class FramePrototipo extends javax.swing.JFrame {

    /**
     * Creates new form Prototipo
     */
    public FramePrototipo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FramePrototipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FramePrototipo().setVisible(true);
            }
        });
    }
